...
export const SecretsSchema = z.object({
  ...
  // Generated by the OpenWA server (random, per install) and auto-captured by
  // `waify setup` from the container's /app/data/.api-key — there is no shared
  // default. Required so a missing key fails loudly instead of silently 401ing.
